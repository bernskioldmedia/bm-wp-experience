...
class Comments {
	...
	public static function remove_comments() {
	 ...
	 *
	 */
	public static function remove_recent_comments_widget() {
	 ...
	 */
	public static function protect_comment_feeds() {
		if ( ! is_comment_feed() ) {
			return;
		}
	 ...
	 */
	public static function remove_comments_from_network_admin_bar( $wp_admin_bar ) {
		// If network activated, remove for all sites.
		if ( BM_WP_Experience::is_network_active() && is_user_logged_in() ) {
	 ...
	 * @param $request
	 */
	public static function disable_adding_comments_from_rest_api( $prepared_comment, $request ) {
		return;
	}
	 ...
	 */
	public static function remove_comments_from_admin_menu() {
		global $pagenow;
